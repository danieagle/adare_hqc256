...
package Adare_Hqc256.inners with Pure is
  ...
  function internal_hqc_256_kem_keypair
    ...
    with Import => True, Convention => StdCall External_Name => "PQCLEAN_HQC256_CLEAN_crypto_kem_keypair";
  ...
  function internal_hqc_256_kem_enc
    ...
    with Import => True, Convention => StdCall External_Name => "PQCLEAN_HQC256_CLEAN_crypto_kem_enc";
  ...
  function internal_hqc_256_kem_dec
    ...
    with Import => True, Convention => StdCall External_Name => "PQCLEAN_HQC256_CLEAN_crypto_kem_dec";
